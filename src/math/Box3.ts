...
export class Box3 {
	...
	public min: Vector3 = undefined;
	public max: Vector3 = undefined;
	...
	init(min, max) {
		...
		this.min = (min !== undefined) ? min : new Vector3().set(+ Infinity, + Infinity, + Infinity);
		this.max = (max !== undefined) ? max : new Vector3().set(- Infinity, - Infinity, - Infinity);
		return this;
	}
