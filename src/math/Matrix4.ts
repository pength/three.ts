...
/**
 * Converted from three.js/Matrix4.js, If you want to see the js source file, please go to https://threejs.org/
...
export class Matrix4 {
	...
	private zero: Vector3 = new Vector3().set(0, 0, 0);
	private one: Vector3 = new Vector3().set(1, 1, 1);

	private vector: Vector3 = new Vector3().set(0, 0, 0);
