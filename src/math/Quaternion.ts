...
/**
 * Converted from three.js/Quaternion.js, If you want to see the js source file, please go to https://threejs.org/
...
export class Quaternion {
	...
	clone(): Quaternion {
		...
		return new Quaternion().set(this._x, this._y, this._z, this._w);
	...
	setFromRotationMatrix(m: Matrix3): Quaternion {
	...
	_slerp(qb: Quaternion, t: number): Quaternion {
